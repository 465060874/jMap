...
import de.geisslerbenjamin.jmap.mediator.EmptyEvent;
        ...
        try {
            ...
            load.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent mouseEvent) {
                    ...
                    factory.createBackgroundImage();

                    // load all elements
                    factory.getDataContainer().set(factory.getTableDataGateway().findAll());
                    factory.getMediator().dispatch("elements.reDraw", new EmptyEvent());
                }
            });
